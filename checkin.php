...
<!-- AQUI TERMINA EL NAV -->
        ...
        <div class="container-fluid">
            ...
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="checkin.php">Check-In</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/user01.png" alt="" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para auditar la informacion requerida para generar el plan de implementacion.
                </div>
            </div>
        </div>

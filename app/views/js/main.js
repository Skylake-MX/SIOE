$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Tienes un folio de seguimiento?",
           text: "Por favor escribe el folio",
           type: "input",   
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí el nombre del folio" }, 
      function(inputValue){
           if (inputValue === false) return false;  

           if (inputValue === "") {
               swal.showInputError("Debes escribir el número de folio");     
               return false;   
           } 
